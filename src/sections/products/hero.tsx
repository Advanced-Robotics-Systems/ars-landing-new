...
const ProductsHero = () => {
  return (
    <section className=" lg:h-screen px-5 md:px-10 lg:px-16 xl:px-40 2xl:px-64 3xl:px-96 py-16 md:py-20 lg:py-20 ">
      <div className="h-full flex flex-col md:flex-row  items-center justify-center rounded-2xl">
        ...
        <motion.div
          className="bg-[#F8F9FC80] text-midnight-blue md:w-2/5 lg:w-1/3 md:h-[470px] lg:h-[510px] xl:h-[550px] rounded-b-2xl md:rounded-l-none md:rounded-r-3xl p-5 lg:p-8 space-y-3 md:space-y-5 lg:spacey-8 xl:space-y-10 flex flex-col justify-center"
        ...
        >
          ...
          <p className="text-sm md:text-[16px] md:leading-6">
            ...
            to create machines and robots that meet client&apos; needs in
