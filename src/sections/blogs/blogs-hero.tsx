    ...
    <section className="bg-gradient-to-tr from-white to-ars-cyan  ">
      <div className="bg-gradient-to-tr from-ice-blue to-[#FFFFFF33] h-full padding-responsive">
        <div className="mt-5">
          ...
          <div className="flex justify-between gap-32 mt-8">
        ...
        <div className="flex justify-between items-center gap-8 mt-12 ">
          ...
          <div className="bg-[#FFFFFF33] p-8 rounded-3xl ">
            <Image
              src={heroImg}
              alt="hero image"
              className="rounded-3xl border-t-4 border-ars-cyan h-[500px] w-full"
            />
            <h1 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl text-deep-blue mt-6 mb-4">
              Testing UX: Best Practices and Strategies
            </h1>
            <div className="flex gap-10 justify-between items-end">
              <p className="text-[#1D2227] w-3/4">
          ...
          <Button
            isIconOnly
            className=" bg-white text-cyan-blue-50 font-medium rounded-r-lg border-l-4 border-cyan-blue-30 hover:bg-deep-blue-20 duration-300"
          >
            {ICONS.arrow_right}
          </Button>
        </div>
