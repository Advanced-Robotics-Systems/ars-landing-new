...
const GetInTouch = () => {
  return (
    <section className="flex flex-col sm:flex-row items-center xs:justify-between max-sm:gap-y-4 bg-midnight-blue padding-responsive py-8 sm:py-16 md:px-24 2xl:px-[12%] 3xl:px-[20%] 4xl:px-[25%]">
